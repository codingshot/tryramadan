      ...
      {sunnahInfo && (
        <Tooltip>
          ...
          <TooltipContent className="max-w-xs p-3">
            ...
            <p className="text-xs text-muted-foreground mt-1 font-arabic" dir="rtl">{GENERAL_TOOLTIPS.sunnah.bodyAr}</p>
          </TooltipContent>
        </Tooltip>
      )}
      ...
      {isAyyamAlBeed && (
        <Tooltip>
          ...
          <TooltipContent className="max-w-xs p-3">
            ...
            <p className="text-xs text-muted-foreground mt-1 font-arabic" dir="rtl">{GENERAL_TOOLTIPS.ayyamAlBeed.bodyAr}</p>
          </TooltipContent>
        </Tooltip>
      )}
