                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a href={benefit.sourceUrl} target="_blank" rel="noopener noreferrer" className="block text-xs text-secondary underline underline-offset-4 mt-2">Source: {benefit.source}</a>
                      </div>
                    </div>
                  </div>
                ))}
