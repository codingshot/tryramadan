...
export const EATING_TIME_TOOLTIPS = {
  ...
  imsak: {
    title: "Imsak • إمساك",
    body: "Some timetables show an earlier precautionary imsak time. The fasting boundary is true dawn (Fajr), not a separate mandatory cutoff ten minutes earlier. Confirm local dawn times with your mosque.",
    bodyAr: "يبدأ الصوم عند طلوع الفجر الصادق.",
  },
  eatCutoff: {
