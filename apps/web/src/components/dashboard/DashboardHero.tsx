                  ...
                  <h2 className="text-xl md:text-2xl font-bold cursor-help border-b border-dotted border-transparent hover:border-foreground/40">
                    {todayExcusedMenstruation
                      ...
                      : todayBroken
                        ? "Broke fast"
                        : inFastingWindow
                          ? isFasting && !todaySkipped && !todayComplete ? "Currently Fasting" : "Fasting Window"
                          : "Eating Window"}
                  </h2>
                </TooltipTrigger>
              ...
              <p className="text-sm text-muted-foreground">
                {todayExcusedMenstruation
                  ...
                  : todayBroken
                    ...
                    : inFastingWindow
                      ? isFasting && !todaySkipped && !todayComplete ? "Fast in progress" : "Fajr to Maghrib · your status is tracked separately"
                      : "You can eat now"}
              </p>
            </div>
          </div>
        ...
        {prayerTimes && (
          <div className="mt-6 pt-6 border-t border-border flex items-center justify-center gap-4 text-sm text-muted-foreground">
            <span title={EATING_TIME_TITLE.suhoor}>
              Suhoor: <span className="font-semibold">{prayerTimes.fajr}</span>
            </span>
            <span>•</span>
